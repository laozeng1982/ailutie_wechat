...
class PartsWithActions {
    ...
    createDefaultPartList() {
        ...
        for (let part of partDictionary.data) {
            ...
            for (let actionIdx = 0; actionIdx < part.actionArray.length; actionIdx++) {
                ...
                action.groupUom = part.actionArray[actionIdx].groupUom;
                action.actionUom = part.actionArray[actionIdx].actionUom;
                action.defaultQuantity = part.actionArray[actionIdx].defaultQuantity;

                action.target.push(part.bodyPart);
                ...
                for (let actionServer of actionGroup.actionSet) {
                    for (let part of this.parts) {
                        for (let actionLocal of part.actionSet) {
                            if (actionServer.name === actionLocal.name) {
                                actionLocal.id = actionServer.id;
                            }
                        }
                    }
                }
    ...
    initGroupSet() {
        for (let part of this.parts) {
            for (let action of part.actionSet) {
                // 临时增加一个数据项，用以保存数据
                action.groupSet = [];
                let length = action.defaultQuantity.totalQuantityOfGroup;
                for (let idx = 0; idx < length; idx++) {
                    let group = new PlanSet.Group(
                        "plan",
                        idx + 1,
                        action.defaultQuantity.quantityPerGroup,
                        action.groupUom,
                        action.defaultQuantity.quantityPerAction,
                        action.actionUom);
    ...
    updateGroupSet(exercise) {
        for (let partIdx = 0; partIdx < this.parts.length; partIdx++) {
            // 先判断大类，即bodyPart是否一样
            if (exercise.action.target[0] === this.parts[partIdx].bodyPart) {
    ...
    addGroupSetToAction(selectedAction, groupSet) {
        for (let part of this.parts) {
            if (part.selected) {
                for (let action of part.actionSet) {
                    if (selectedAction.target[0] === action.target[0] && selectedAction.name === action.name) {
            ...
            actionArray: [
                {
                    ...
                    actionUom: "Km",
                    defaultQuantity: {totalQuantityOfGroup: 1, quantityPerGroup: 30, quantityPerAction: 5},
                },
                {
                    name: '原地跑步',
                    equipment: "",
                    ...
                    actionUom: "次",
                    defaultQuantity: {totalQuantityOfGroup: 1, quantityPerGroup: 30, quantityPerAction: 100},
                },
                {
                    name: '原地高抬腿',
                    equipment: "",
                    ...
                    actionUom: "次",
                    defaultQuantity: {totalQuantityOfGroup: 6, quantityPerGroup: 10, quantityPerAction: 100},
                },
                {
                    name: '快走',
                    equipment: "",
                    ...
                    actionUom: "Km",
                    defaultQuantity: {totalQuantityOfGroup: 1, quantityPerGroup: 30, quantityPerAction: 3},
                },
                {
                    name: '椭圆机',
                    equipment: "",
                ...
                },
                {
                    ...
                    actionUom: "Km",
                    defaultQuantity: {totalQuantityOfGroup: 1, quantityPerGroup: 30, quantityPerAction: 8},
                },
                {
                    name: '登山机',
                    equipment: "",
                ...
                },
                {
                    ...
                    actionUom: "个",
                    defaultQuantity: {totalQuantityOfGroup: 6, quantityPerGroup: 3, quantityPerAction: 50},
                },
                {
                    name: '俯身登山',
                    equipment: "",
                    ...
                    actionUom: "个",
                    defaultQuantity: {totalQuantityOfGroup: 6, quantityPerGroup: 5, quantityPerAction: 50},
                },
            ]
        });
            ...
            actionArray: [
                {
                    ...
                    actionUom: "Kg",
                    defaultQuantity: {totalQuantityOfGroup: 6, quantityPerGroup: 10, quantityPerAction: 30},
                },
                {
                    name: '上斜哑铃推举',
                    equipment: "",
                    ...
                    actionUom: "Kg",
                    defaultQuantity: {totalQuantityOfGroup: 6, quantityPerGroup: 10, quantityPerAction: 20},
                },
                {
                    name: '上斜器械推举',
                    equipment: "",
                ...
                },
                {
                    ...
                    actionUom: "Kg",
                    defaultQuantity: {totalQuantityOfGroup: 6, quantityPerGroup: 10, quantityPerAction: 0},
                },
                {
                    name: '上斜哑铃飞鸟',
                    equipment: "",
        ...
        this.data.push({
            ...
            actionArray: [
                ...
                },
                {
                    ...
                    actionUom: "Kg",
                    defaultQuantity: {totalQuantityOfGroup: 6, quantityPerGroup: 10, quantityPerAction: 10},
                },
                {
                    name: '站姿哑铃前平举',
                    equipment: "",
            ...
            actionArray: [
                {
                    ...
                    actionUom: "Kg",
                    defaultQuantity: {totalQuantityOfGroup: 6, quantityPerGroup: 10, quantityPerAction: 50},
                },
                {
                    name: '颈前杠铃深蹲',
                    equipment: "",
                ...
                },
                {
                    ...
                    actionUom: "Kg",
                    defaultQuantity: {totalQuantityOfGroup: 6, quantityPerGroup: 10, quantityPerAction: 40},
                },
                {
                    name: '坐姿单腿腿举',
                    equipment: "",
